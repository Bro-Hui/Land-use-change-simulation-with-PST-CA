...
# Classification training using random forest,2006 data as input
rfc = RandomForestClassifier(n_estimators=5)
rfc.fit(ann_data_train, ann_data_train_label)

Label_predict = rfc.predict(Sample_2010_Norm)
...
np.savetxt('/home/anaconda_workspace/qyh/SH_100m/ExperimentalResult/Conventional_Models/RF_CA.txt', data_new, fmt='%s', newline='\n')