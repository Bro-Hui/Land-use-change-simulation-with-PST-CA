...
clf = model.fit(ann_data_train,ann_data_train_label)
Label_predict = clf.predict(Sample_2010_Norm)
...
np.savetxt('/home/anaconda_workspace/qyh/SH_100m/ExperimentalResult/Conventional_Models/SVM_CA.txt', data_new, fmt='%s', newline='\n')